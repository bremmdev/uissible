...
describe("Dropdown", () => {
  ...
  it('should NOT focus on render when it does not have autoFocus prop', () => {
    render(<Dropdown options={["apple", "banana", "kiwi"]}/>);
  ...
  it('should focus on render when it has autoFocus prop', () => {
    render(<Dropdown options={["apple", "banana", "kiwi"]} autoFocus/>);
  ...
  describe("Dropdown button", () => {
    ...
    it("should render placeholder if there is no option selected", () => {
      render(<Dropdown placeholder="Please choose your favorite fruit" options={["apple", "banana", "kiwi"]} value=""/>);
    ...
    it("should NOT render placeholder if there is an option selected", () => {
      render(<Dropdown placeholder="Please choose your favorite fruit" options={["apple", "banana", "kiwi"]} value="apple" />);
    ...
    it("should NOT render default placeholder if there is an option selected", () => {
      render(<Dropdown placeholder="" options={["apple", "banana", "kiwi"]} value="apple"/>);
    ...
    it('should NOT render an invalid option', () => {
      render(<Dropdown placeholder="Please choose your favorite fruit" options={["apple", "banana", "kiwi"]} value="melon"/>);
    ...
    describe("Clear input button", () => {
      it("should NOT render if dropdown is NOT clearable", () => {
        render(<Dropdown options={["apple", "banana", "kiwi"]} value="kiwi"/>);
        expect(screen.queryByRole('button', { name: /clear input/i})).toBeNull()
      })
  
      it("should NOT render if there is no value", () => {
        render(<Dropdown options={["apple", "banana", "kiwi"]} clearable/>);
        expect(screen.queryByRole('button', { name: /clear input/i})).toBeNull()
      })
  
      it("should NOT render if there is an invalid value", () => {
        render(<Dropdown options={["apple", "banana", "kiwi"]} value="melon" clearable/>);
        expect(screen.queryByRole('button', { name: /clear input/i})).toBeNull()
      })
  
      it("should render if there is a valid value", () => {
        render(<Dropdown options={["apple", "banana", "kiwi"]} value="kiwi" clearable/>);
      ...
      it('should show placeholder if we click the clear button', async () => {
        ...
        render(<Dropdown options={["apple", "banana", "kiwi"]} clearable value="kiwi"/>);
        expect(screen.queryByRole('button', { name: /kiwi/i })).toBeInTheDocument()
        await user.click(screen.queryByRole('button', { name: /clear input/i}))
